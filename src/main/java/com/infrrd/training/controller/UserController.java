...
public class UserController {
	...
	// End point to update a user's address whose userId=uid
	@PostMapping(value = "/updateuser/{uid}/{address}", produces = MediaType.APPLICATION_JSON_VALUE) 
	public void updateUser(@PathVariable String uid, @PathVariable String address) {
		try {
			userService.updateUser(uid, address);
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
